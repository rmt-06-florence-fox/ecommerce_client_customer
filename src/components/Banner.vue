  ...
  <div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel">
    <div class="carousel-inner" style="max-height: 250px;">
        <div class="carousel-item active" style="max-height: 250px;">
            <div style="max-height: 250px;" class="mask flex-center">
                <div class="container" style="max-height: 250px;">
                    <div class="row align-items-center" style="max-height: 250px;">
                        <div class="col-md-7 col-12 order-md-1 order-2">
                            <h4>Online School</h4>
                            <p class="">Sekolah online? Siapa takut.</p> <br> <a href="#">COMING SOON</a>
                        </div>
                        <div class="col-md-5 col-12 order-md-2 order-1"><img style="max-height: 250px;" src="https://res.cloudinary.com/dxfq3iotg/image/upload/v1564246609/Ecommerce/img-2.jpg" class="mx-auto" alt="slide"></div>
                    </div>
                </div>
            </div>
        </div>
