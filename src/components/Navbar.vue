<template>
  <nav class="navbar sticky-top navbar-light shadow bg-light mb-4">
    <a class="navbar-brand font-weight-bold" style="cursor: pointer" @click.prevent="toMainPage">Han Store</a>
    <div>
