    ...
    <div class="flex-1">
      ...
      <div class="my-4 mt-6 -mx-2 lg:flex">
        <div class="lg:px-2 lg:w-1/2">
          ...
          <div class="p-4">
            <p class="mb-4 italic">If you have some additionnal information for this purchase you can leave them in the box below</p>
        ...
        <div class="lg:px-2 lg:w-1/2">
          ...
          <div class="p-4">
            <p class="mb-6 italic">Total Cost are calculated based on values you have entered</p>
              ...
              <a href="#">
                <button @click="checkout" class="flex justify-center w-full px-10 py-3 mt-6 font-medium text-white uppercase bg-gray-800 rounded-full shadow item-center hover:bg-gray-700 focus:shadow-outline focus:outline-none">
